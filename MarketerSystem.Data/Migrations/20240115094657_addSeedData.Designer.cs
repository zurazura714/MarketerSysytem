...
namespace MarketerSystem.Data.Migrations
{
    ...
    [Migration("20240115094657_addSeedData")]
            ...
            modelBuilder.Entity("MarketerSystem.Domain.Model.BonusPayment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BonusPay = 10m,
                            DistributorID = 1,
                            FromDate = new DateTimeOffset(new DateTime(2024, 1, 15, 8, 46, 56, 724, DateTimeKind.Unspecified).AddTicks(7196), new TimeSpan(0, 4, 0, 0, 0)),
                            ToDate = new DateTimeOffset(new DateTime(2024, 1, 15, 13, 46, 56, 724, DateTimeKind.Unspecified).AddTicks(7205), new TimeSpan(0, 4, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("MarketerSystem.Domain.Model.Distributor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DistributorGuid = new Guid("5a7d104c-7335-4e91-9837-f3d58019781a"),
                            FirstName = "Zura",
                            Gender = 1,
                        ...
                        new
                        {
                            ...
                            DistributorGuid = new Guid("10257356-be2b-4443-a63d-f7b47c39d5c2"),
                            FirstName = "Maiko",
                            Gender = 2,
                            LastName = "Samkharadze",
                            PassportID = 2
            ...
            modelBuilder.Entity("MarketerSystem.Domain.Model.Passport", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReleaseDate = new DateTimeOffset(new DateTime(2024, 1, 15, 13, 46, 56, 724, DateTimeKind.Unspecified).AddTicks(7103), new TimeSpan(0, 4, 0, 0, 0))
                        },
                        new
                        {
                            ID = 2,
                            ...
                            ReleaseDate = new DateTimeOffset(new DateTime(2024, 1, 15, 13, 46, 56, 724, DateTimeKind.Unspecified).AddTicks(7118), new TimeSpan(0, 4, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("MarketerSystem.Domain.Model.Sell", b =>
                {
                    ...
                    b.Property<bool>("UsedForPayment")
                        .HasColumnType("bit");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProductID = 1,
                            ProductPrice = 10m,
                            ProductTotalPrice = 10m,
                            ProductUnitPrice = 10m,
                            SoldDate = new DateTimeOffset(new DateTime(2024, 1, 15, 13, 46, 56, 724, DateTimeKind.Unspecified).AddTicks(7183), new TimeSpan(0, 4, 0, 0, 0)),
