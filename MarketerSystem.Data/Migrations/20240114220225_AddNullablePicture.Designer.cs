...
namespace MarketerSystem.Data.Migrations
{
    ...
    [Migration("20240114220225_AddNullablePicture")]
    partial class AddNullablePicture
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MarketerSystem.Domain.Model.Distributor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DistributorGuid = new Guid("0c3b5913-f41f-4e3b-96f0-b62a194c2781"),
                            FirstName = "Zura",
                            Gender = 1,
                        ...
                        new
                        {
                            ...
                            DistributorGuid = new Guid("1cba4aa7-2b5b-4894-8fd7-7eaf77760138"),
                            FirstName = "Maiko",
                            Gender = 2,
                            LastName = "Samkharadze",
                            PassportID = 2
            ...
            modelBuilder.Entity("MarketerSystem.Domain.Model.Passport", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReleaseDate = new DateTimeOffset(new DateTime(2024, 1, 15, 2, 2, 24, 990, DateTimeKind.Unspecified).AddTicks(4600), new TimeSpan(0, 4, 0, 0, 0))
                        },
                        new
                        {
                            ID = 2,
                            ...
                            ReleaseDate = new DateTimeOffset(new DateTime(2024, 1, 15, 2, 2, 24, 990, DateTimeKind.Unspecified).AddTicks(4613), new TimeSpan(0, 4, 0, 0, 0))
                        });
                });
