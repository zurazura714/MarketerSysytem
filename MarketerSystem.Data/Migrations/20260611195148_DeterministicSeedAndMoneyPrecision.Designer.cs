...
namespace MarketerSystem.Data.Migrations
{
    ...
    [Migration("20260611195148_DeterministicSeedAndMoneyPrecision")]
    partial class DeterministicSeedAndMoneyPrecision
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MarketerSystem.Domain.Model.BonusPayment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BonusPay = 10m,
                            DistributorID = 1,
                            FromDate = new DateTimeOffset(new DateTime(2024, 1, 14, 19, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            ToDate = new DateTimeOffset(new DateTime(2024, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("MarketerSystem.Domain.Model.Distributor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DistributorGuid = new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"),
                            FirstName = "Zura",
                            Gender = 1,
                        ...
                        new
                        {
                            ...
                            DistributorGuid = new Guid("e2c1a7e0-4f2b-4f6a-9b3a-1c9d2e8f4a5b"),
                            FirstName = "Maiko",
                            Gender = 2,
                            LastName = "Samkharadze",
                            PassportID = 2
            ...
            modelBuilder.Entity("MarketerSystem.Domain.Model.Passport", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DocumentSerie = "11111",
                            DocumentType = 1,
                            ExpirationDate = new DateTimeOffset(new DateTime(2028, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IssuingAgency = "SA Agency",
                            PersonalNumber = "01008048552",
                            ReleaseDate = new DateTimeOffset(new DateTime(2024, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            ID = 2,
            ...
            modelBuilder.Entity("MarketerSystem.Domain.Model.Sell", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SoldDate = new DateTimeOffset(new DateTime(2024, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
